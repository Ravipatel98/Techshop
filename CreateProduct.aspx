<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="CreateProduct.aspx.cs" Inherits="MidWebsite.CreateClient" %>
        ...
        <div>
            ...
            <div class="auto-style2">
                <div class="form-inline">    
                    <h3 class="alert alert-info">Product Management</h3>          
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success table-responsive ">
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:TextBox runat="server" ID="txtName"  placeholder="Product Name" required  CssClass="form-control"/>
                            </td>
                            <td>
                                 <asp:TextBox runat="server" ID="txtChance"  placeholder="Product Code" required CssClass="form-control"/>
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtBudget"  placeholder="Prize" required  CssClass="form-control"/>
                            </td>
                            <td>
                             ...
                             <td>
                                <asp:TextBox runat="server" ID="TextBox1"  placeholder="Description" required  CssClass="form-control"/>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Button Text="Add Product" runat="server" ID="btnAdd" 
